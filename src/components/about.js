...
const About = () => {
  return (
    <section id="about" className="fade-in" aria-label="À propos de Amira">
      <h2>À propos</h2>
      <p>
       Développeuse Front-End spécialisée en React.js, Next.js, TypeScript et JavaScript (ES6+).<br/> Expérience dans la création d'interfaces web responsives et accessibles avec Tailwind CSS, Shadcn UI et DaisyUI,
intégration d'APIs REST et optimisation des performances.<br/>
