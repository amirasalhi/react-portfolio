...
const About = () => {
  return (
    <section id="about" className="fade-in" aria-label="À propos de Amira">
      <h2>À propos</h2>
      <p>
       hello Passionnée par le développement front-end, je conçois des interfaces web modernes, fluides et soignées. J’attache une grande importance à la clarté du design, à l’expérience utilisateur, ainsi qu’à la qualité du code.
