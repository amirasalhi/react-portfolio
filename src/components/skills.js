		...
		<section id="skills" tabIndex="-1" className="fade-in" aria-label="Compétences techniques">
		  ...
		  <div className="skills-grid" role="list">
			<article className="skill" role="listitem" tabIndex="0" aria-label="seo">
			  <span className="skill-icon" aria-hidden="true"><img src="images/react.png" alt=""/></span>
			  <h3>React</h3>
			</article>
			<article className="skill" role="listitem" tabIndex="0" aria-label="ps">
			  <span className="skill-icon" aria-hidden="true"><img src="images/nextjs.png" alt=""/></span>
			  <h3>Next.JS</h3>
			</article>
			<article className="skill" role="listitem" tabIndex="0" aria-label="JavaScript">
			  <span className="skill-icon" aria-hidden="true"><img src="images/js.png" alt=""/></span>
			  <h3>JavaScript</h3>
			</article>
			<article className="skill" role="listitem" tabIndex="0" aria-label="ps">
			...
			<article className="skill" role="listitem" tabIndex="0" aria-label="CSS3">
			  <span className="skill-icon" aria-hidden="true"><img src="images/css3.png" alt=""/></span>
			  <h3>CSS3</h3>
			</article>
			<article className="skill" role="listitem" tabIndex="0" aria-label="CSS3">
			  <span className="skill-icon" aria-hidden="true"><img src="images/tailwindcss.png" alt=""/></span>
			  <h3>Tailwind css</h3>
			</article>
				<article className="skill" role="listitem" tabIndex="0" aria-label="sass">
			  <span className="skill-icon" aria-hidden="true"><img src="images/sass.png" alt=""/></span>
			  <h3>SaSS</h3>
			</article>
		<article className="skill" role="listitem" tabIndex="0" aria-label="CSS3">
			  <span className="skill-icon" aria-hidden="true"><img src="images/shadcn.png" alt=""/></span>
			  <h3>Shadcn UI</h3>
			</article>
			<article className="skill" role="listitem" tabIndex="0" aria-label="CSS3">
			  <span className="skill-icon" aria-hidden="true"><img src="images/daisyui.png" alt=""/></span>
			  <h3>DaisyUI</h3>
			</article>
			
			<article className="skill" role="listitem" tabIndex="0" aria-label="Git">
			  <span className="skill-icon" aria-hidden="true"><img src="images/github.png" alt=""/></span>
			  <h3>Git</h3>
			</article>
